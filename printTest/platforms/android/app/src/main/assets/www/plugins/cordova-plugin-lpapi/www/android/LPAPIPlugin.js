cordova.define("cordova-plugin-lpapi.LPAPIPlugin", function(require, exports, module) {
    ...
    var Actions = {
        ...
        ACTION_GET_FIRST_PRINTER: "getFirstPrinter",
        ACTION_GET_PRINTER_NAME: "getPrinterName",
        ACTION_GET_PRINTER_STATE: "getPrinterState",
        ACTION_GET_PRINTER_INFO: "getPrinterInfo",
    ...
    api.getAllPrinters = function (args, success) {
        exec(success, null, serviceName, Actions.ACTION_GET_ALL_PRINTER, args || {});
    };
    api.getAllPrinterAddresses = function (args, success) {
        exec(success, null, serviceName, Actions.ACTION_GET_ALL_PRINTER_ADDRESS, args || {});
    };
    api.getFirstPrinter = function (args, success) {
        exec(success, null, serviceName, Actions.ACTION_GET_FIRST_PRINTER, args ||{});
    };
    api.getPrinterState = function (success) {
        exec(success, null, serviceName, Actions.ACTION_GET_PRINTER_STATE, {});
    };
    api.getPrinterInfo = function (success) {
        exec(success, null, serviceName, Actions.ACTION_GET_PRINTER_INFO, {});
    };
    api.getPrinterName = function (success) {
        exec(success, null, serviceName, Actions.ACTION_GET_PRINTER_NAME, {});
    };
    api.isPrinterOpened = function (success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_IS_PRINTER_OPENED, {});
    };
    api.openPrinter = function (args, success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_OPEN_PRINTER, args || {});
    };
    api.reopenPrinter = function (success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_REOPEN_PRINTER, {});
    };
    api.closePrinter = function () {
        exec(null, null, serviceName, Actions.ACTION_CLOSE_PRINTER, {});
    };
    // 参数获取与设置
    api.getItemHorizontalAlignment = function (success) {
        exec(success, null, serviceName, Actions.ACTION_GET_HORIZONTAL_ALIGNMENT, {});
    };
    api.setItemHorizontalAlignment = function (args, success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_SET_HORIZONTAL_ALIGNMENT, args || {});
    };
    api.getItemVerticalAlignment = function (success) {
        exec(success, null, serviceName, Actions.ACTION_GET_VERTICAL_ALIGNMENT, {});
    };
    api.setItemVerticalAlignment = function (args, success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_SET_VERTICAL_ALIGNMENT, args || {});
    };
    api.getItemOrientation = function (success) {
        exec(success, null, serviceName, Actions.ACTION_GET_ORIENTATION, {});
    };
    api.setItemOrientation = function (args, success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_SET_ORIENTATION, args || {});
    };
    api.getItemPenAlignment = function (success) {
        exec(success, null, serviceName, Actions.ACTION_GET_PEN_ALIGNMENT, {});
    };
    api.setItemPenAlignment = function (args, success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_SET_PEN_ALIGNMENT, args || {});
    };
    // 打印任务及打印页面
    api.startJob = function (args, success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_START_JOB, args);
    };
    api.endJob = function () {
        exec(null, null, serviceName, Actions.ACTION_END_JOB, {});
    };
    ...
    api.abortJob = function () {
        exec(null, null, serviceName, Actions.ACTION_ABORT_JOB, {});
    };
    api.startPage = function (success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_START_PAGE, {});
    };
    api.endPage = function () {
        exec(null, null, serviceName, Actions.ACTION_END_PAGE, {});
    };
    api.cancel = function () {
        exec(null, null, serviceName, Actions.ACTION_CANCEL, {});
    };
    api.getJobPages = function (success) {
        exec(success, null, serviceName, Actions.ACTION_GET_JOBPAGES, {});
    };
    api.printImage = function (args, success, fail) {
        exec(success, fail, serviceName, Actions.ACTION_PRINT_IMAGE, args || {});
    };
    // 打印对象的绘制
    api.drawText = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_TEXT, args || {});
    };
    api.drawRichText = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_RICH_TEXT, args || {});
    };
    api.draw1DBarcode = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_BARCODE, args || {});
    };
    api.draw2DPdf417 = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_PDF417, args || {});
    };
    api.draw2DQRCode = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_QRCODE, args || {});
    };
    api.drawLine = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_LINE, args || {});
    };
    api.drawDashLine = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_DASH_LINE, args || {});
    };
    api.drawRectangle = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_RECTANGLE, args);
    };
    api.drawRoundRectangle = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_ROUND_RECTANGLE, args || {});
    };
    api.drawEllipse = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_ELLIPSE, args || {});
    };
    api.drawCircle = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_CIRCLE, args || {});
    };
    api.fillRectangle = function (args) {
        exec(null, null, serviceName, Actions.ACTION_FILL_RECTANGLE, args || {});
    };
    api.fillRoundRectangle = function (args) {
        exec(null, null, serviceName, Actions.ACTION_FILL_ROUND_RECTANGLE, args || {});
    };
    api.fillEllipse = function (args) {
        exec(null, null, serviceName, Actions.ACTION_FILL_ELLIPSE, args || {});
    };
    api.fillCircle = function (args) {
        exec(null, null, serviceName, Actions.ACTION_FILL_CIRCLE, args || {});
    };
    api.drawImage = function (args) {
        exec(null, null, serviceName, Actions.ACTION_DRAW_IMAGE, args || {});
    };
